    ...
    extends Applet
{
    ...
    private void initGUI()
    {
        ...
        this.goButton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                if (isInputValid())
                {
                    PiApplet.this.statusArea.setText(null);
                    PiApplet.this.resultArea.setText(null);
                    PiApplet.this.goButton.setEnabled(false);
                    startThread();
                }
            }
        });
        ...
        this.abortButton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                PiApplet.this.abortButton.setEnabled(false);
                stopThread();
            }
        });
    }
    ...
    private void startThread()
    {
        ...
        Pi.setOut(new PrintWriter(new FlushStringWriter(PiApplet.this.resultArea), true));

        // Writer for writing standard error output to the status area
        Pi.setErr(new PrintWriter(new FlushStringWriter(PiApplet.this.statusArea), true));
        ...
        this.calculatorThread = new Thread()
        {
            public void run()
            {
                long precision = Long.parseLong(PiApplet.this.precisionField.getText());
                int radix = Integer.parseInt(PiApplet.this.radixChoice.getSelectedItem());
