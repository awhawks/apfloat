    ...
    extends LongTableFNTStrategy
{
    ...
    protected void multiplyElements(Object key, final ArrayAccess arrayAccess, final int startRow, final int rows, final int columns, final long w, final long scaleFactor)
    ...
    protected void transformRows(Object key, final int length, final int count, final boolean isInverse, final ArrayAccess arrayAccess, final long[] wTable, final int[] permutationTable)
        throws ApfloatRuntimeException
    {
        ParallelRunnable parallelRunnable = new ParallelRunnable()
        {
